...
class UserProfile(models.Model):
    ...
    user_image = models.ImageField(upload_to='profile_pics/', default='default_profile.png')
    user_cover = models.ImageField(upload_to='cover_pics/', default='default_cover.jpg')
